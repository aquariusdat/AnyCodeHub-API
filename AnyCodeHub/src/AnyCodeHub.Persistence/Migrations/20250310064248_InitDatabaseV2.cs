    ...
    public partial class InitDatabaseV2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    BenefitContent = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseBenefits_Course_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Course",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseBenefits_Course_CourseId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseQAs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseQAs_Course_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Course",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseQAs_Course_CourseId1",
                        column: x => x.CourseId1,
                        principalTable: "Course",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    RequirementContent = table.Column<string>(type: "text", nullable: false),
                    CourseId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "now()"),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseCategories_Course_CourseId1",
                        column: x => x.CourseId1,
                        principalTable: "Course",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseComments_Course_CourseId1",
                        column: x => x.CourseId1,
                        principalTable: "Course",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseTechnologies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseTechnologies_Course_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Course",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseBenefits_CourseId1",
                table: "CourseBenefits",
                column: "CourseId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseCategories_CourseId1",
                table: "CourseCategories",
                column: "CourseId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseComments_CourseId1",
                table: "CourseComments",
                column: "CourseId1");

            migrationBuilder.CreateIndex(
                name: "IX_CourseQAs_CourseId",
                table: "CourseQAs",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseQAs_CourseId1",
                table: "CourseQAs",
                column: "CourseId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseTechnologies_CourseId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Course_AppUsers_AuthorId",
                table: "Course",
                column: "AuthorId",
                principalTable: "AppUsers",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Course_AppUsers_AuthorId1",
                table: "Course",
                column: "AuthorId1",
                principalTable: "AppUsers",
                principalColumn: "Id",
