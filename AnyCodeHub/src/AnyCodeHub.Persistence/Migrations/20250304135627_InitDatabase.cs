        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BirthOfDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentId = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    SortOrder = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ActionId = table.Column<string>(type: "character varying(50)", nullable: false),
                    FunctionId = table.Column<string>(type: "character varying(50)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "CREATE", true, "CREATE", 0 },
                    { "DELETE", true, "DELETE", 0 },
                    { "READ", true, "READ", 0 },
                    { "UPDATE", true, "UPDATE", 0 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUsers_Email_UserName",
                table: "AppUsers",
