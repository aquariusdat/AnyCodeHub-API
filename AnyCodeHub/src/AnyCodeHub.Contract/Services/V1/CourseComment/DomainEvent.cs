...
{
    public record CourseCommentCreated(Guid EventId, Guid Id, Guid CourseId, Guid CommentId, string Content, Guid CreatedBy, DateTime CreatedAt) : IDomainEvent
    {
        public Guid Id { get; set; } = Id;
        public DateTimeOffset TimeStamp { get; set; } = CreatedAt;
    }

    public record CourseCommentUpdated(Guid EventId, Guid Id, Guid CourseId, Guid CommentId, string Content, Guid? UpdatedBy, DateTime? UpdatedAt) : IDomainEvent
    {
        public Guid Id { get; set; } = Id;
